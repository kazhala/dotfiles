...
vim.api.nvim_set_keymap('n', '<M-k>', '<CMD>lua require("kaz.utils.window").resize("up", 3)<CR>', kb.noremap)
vim.api.nvim_set_keymap('n', '<M-j>', '<CMD>lua require("kaz.utils.window").resize("down", 3)<CR>', kb.noremap)
vim.api.nvim_set_keymap('n', '<M-l>', '<CMD>vertical-resize -3<CR>', kb.noremap)
vim.api.nvim_set_keymap('n', '<M-h>', '<CMD>vertical-resize +3<CR>', kb.noremap)
