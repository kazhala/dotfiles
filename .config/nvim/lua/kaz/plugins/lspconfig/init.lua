...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', ']g', '<CMD>lua vim.diagnostic.goto_next()<CR>', kb.silent_noremap)
  buf_set_keymap('n', '[g', '<CMD>lua vim.diagnostic.goto_prev()<CR>', kb.silent_noremap)
end

require('kaz.plugins.lspconfig.pyright').setup(on_attach)
require('kaz.plugins.lspconfig.lua_ls').setup(on_attach)
