...
vim.keymap.set('n', '<leader>go', function()
  codelink.open({ platform = 'github', line = true })
end)
vim.keymap.set('n', '<leader>gb', function()
  codelink.open({ platform = 'github', branch = vim.fn.input('Branch: ', '') })
end)
vim.keymap.set('n', '<leader>gs', function()
  codelink.open({ platform = 'sourcegraph', line = true })
end)
vim.keymap.set('n', '<leader>gc', function()
  codelink.copy_filename({ relative = true })
end)

-- LSP
vim.keymap.set('n', 'K', function()
  vim.lsp.buf.hover({ border = vim.g.floating_window_border })
