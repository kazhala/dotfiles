# Generated by Powerlevel10k configuration wizard on 2020-04-18 at 14:19 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline
    vifm_shell              # vifm shell indicator
  ...
  # vifm shell indicator
  function prompt_vifm_shell() {
    if [[ ! -z "$VIFM" ]]
    then
